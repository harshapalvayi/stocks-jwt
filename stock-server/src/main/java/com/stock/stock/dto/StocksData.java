...
public class StocksData {
    ...
    public static Comparator<StocksData> getStockPercentageChange() {
        return stockPercentageChange;
    }

    public static void setStockPercentageChange(Comparator<StocksData> stockPercentageChange) {
        StocksData.stockPercentageChange = stockPercentageChange;
    }
...
/* Sorting the list by percentage change*/
    public static Comparator<StocksData> stockPercentageChange = (s1, s2) -> {
        int compare = 0;
